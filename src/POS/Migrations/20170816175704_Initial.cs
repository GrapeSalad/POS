        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Availability = table.Column<bool>(nullable: false),
                    BottlePrice = table.Column<float>(nullable: false),
                    GlassPrice = table.Column<float>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    OrderId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Entres", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Entres_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MixedDrinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MixedDrinks_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(nullable: true),
                    Producer = table.Column<string>(nullable: true),
                    Varietals = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entres_OrderId",
                table: "Entres",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_MixedDrinks_OrderId",
                table: "MixedDrinks",
                column: "OrderId");
